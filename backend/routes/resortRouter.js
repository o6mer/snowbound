...
const { getResortByBame, updateResort, getAllCountry, getMultipleResortByBame, getResortByCountry, deleteResortByBame, createResort, getAllResorts, getCountryByContinent } = require("../controllers/resortController");
...
resortRouter.get("/countrybycont", getCountryByContinent);
