...
const SearchPage = () => {
  return (
    <div>
      <Navbar />
      <header className="w-full h-96 bg-[url('./assets/HeroSearch.png')] bg-cover bg-center flex justify-center items-center">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="mt-5 text-center text-lg text-blue opacity-70">
            Plese choose the country you want to visit
          </p>
