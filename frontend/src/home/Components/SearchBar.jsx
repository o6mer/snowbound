    ...
    <div className="relative">
      <form className="flex flex-col mt-10 items-center w-full mb-4 md:flex-row md:px-16">
        ...
        <button
          ...
          type="button"
          className="inline-flex items-center justify-center w-full h-14 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md md:w-auto  bg-blue-500 hover:bg-blue-700 focus:shadow-outline focus:outline-none"
        >
          <SearchIcon /> Search
        </button>
      </form>
