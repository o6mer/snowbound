...
const HomeHero = () => {
  return (
    <header className="w-full h-200px bg-[url('./assets/HeroHome.jpg')] bg-cover bg-[0px_-200px] bg-no-repeat  flex justify-center items-center">
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="mt-5 text-center text-lg text-orange-600	 font-normal		">
          This Website is about finding you your best vecation.
        </p>
